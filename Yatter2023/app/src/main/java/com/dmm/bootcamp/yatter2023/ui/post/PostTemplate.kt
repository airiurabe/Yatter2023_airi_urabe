...
import com.dmm.bootcamp.yatter2023.ui.theme.defaultButtonColors
    ...
    Scaffold(
        ...
        Column {
            Button(
                ...
                enabled = canPost,
                modifier = Modifier
                    .padding(end = 8.dp) //右端から2dpだけ内側に配置
                    .align(Alignment.End), //右端に配置
                colors = defaultButtonColors() // カスタムボタンの色を適用
            ) {
                Text(text = "ツイート")
            }
        ...
        Surface{
            PostTemplate(
                ...
                onStatusTextChanged = { statusText ->
                    // ここにプレビューで実行したいコードを記述します
                    println("Status text changed in preview: $statusText")
                },
                onClickPost = {},
                onClickNavIcon = {}
            )
